 ...
 *
 * For books/papers, current displays under "Now".
 * For films, current displays under "Prev" for things watched before this site existed.
 *
...
export const library: Record<'books' | 'papers' | 'films', LibraryCategory> = {
  ...
  films: {
    // "current" is intentionally used as the special "Prev" section
    // for films watched before this website existed.
    current: [
      {
    ...
    // Add films watched after the site launch here by year.
    years: [],
  },
};
